...
class ResourceArgs:
    ...
    @property
    @pulumi.getter
    def access(self) -> Optional[pulumi.Input['ResourceAccessArgs']]:
        """
    ...
    @access.setter
    def access(self, value: Optional[pulumi.Input['ResourceAccessArgs']]):
...
class Resource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def access(self) -> pulumi.Output[Optional['outputs.ResourceAccess']]:
        """
        Restrict access to certain groups or service accounts
        """
        return pulumi.get(self, "access")
